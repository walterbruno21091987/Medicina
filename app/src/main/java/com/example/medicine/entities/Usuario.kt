...
class Usuario(nombre:String, apellido:String, dni:Int,val contrasenia:String,val imageUser: Int = R.drawable.iconopersona, val numberAfiliado:Int):Persona(nombre,apellido,dni) {

...
class Usuario(nombre:String, apellido:String, dni:Int,val email:String,val contrasenia:String,val numberAfiliado:Int,val imageUser:Int =R.drawable.iconopersona):Persona(nombre,apellido,dni) {
